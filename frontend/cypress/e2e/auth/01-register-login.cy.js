...
describe("Full Cycle of User Account", () => {
  let first_name = "Sweeney",
    last_name = "Todd",
    user_name = "BarberOnFleet",
    email = "stodd@gmail.com",
  ...
  describe("registration form", () => {
    it("allows user to create account", () => {
      ...
      cy.wait(800).findByText("Registration successful").should("exist");
    });
  });
  ...
  describe("login and profile forms", () => {
    it("allows user with account to login", () => {
      ...
      // eslint-disable-next-line cypress/no-unnecessary-waiting
      cy.wait(800).findByText(`Hi ${user_name}!`).should("exist");
      ...
      // eslint-disable-next-line cypress/no-unnecessary-waiting
      cy.wait(800).findByText("Account successfully deleted").should("exist");
    });
  });
});
