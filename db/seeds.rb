...
FactoryBot.create(:user, email: 'picard@gmail.com', first_name: 'Jean Luc', last_name: 'Picard', password: '123456', password_confirmation: '123456', role: 3)
FactoryBot.create(:user, email: 'riker@gmail.com', first_name: 'William', last_name: 'Riker', password: '123456', password_confirmation: '123456', role: 2)
FactoryBot.create(:user, email: 'laforge@gmail.com', first_name: 'Geordi', last_name: 'La Forge', password: '123456', password_confirmation: '123456', role: 1)
...
FactoryBot.create(:user, email: 'data@gmail.com', first_name: 'Data', last_name: 'Soong', password: '123456', password_confirmation: '123456', role: 1)
